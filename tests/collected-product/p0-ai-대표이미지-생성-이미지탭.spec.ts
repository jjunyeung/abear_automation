/**
 * AI 대표이미지 생성 / 이미지탭 영역 P0 TC 묶음 (2건) — skeleton ATC, destructive/외부/AI/환경 의존 → 진입 + noop log.
 */
...
const handlers: StepHandlers = {
  "tc3710_수집상품-모달-오픈": verifyPageReachable,
  "tc3711_등록상품-모달-오픈": noopAfter("tc3711_등록상품-모달-오픈", 'destructive / 환경 의존 / AI 비결정 — skip'),
};

test("AI 대표이미지 생성 / 이미지탭 영역 P0 TC 묶음 (2건) — 진입 + destructive/AI noop skip", async ({ page }) => {
