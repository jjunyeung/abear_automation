/**
 * AI 대표이미지 생성 / 취소 영역 P0 TC 묶음 (1건) — skeleton ATC, destructive/외부/AI/환경 의존 → 진입 + noop log.
 */
...
const handlers: StepHandlers = {
  "tc3716_취소-버튼-클릭": verifyPageReachable,
};

test("AI 대표이미지 생성 / 취소 영역 P0 TC 묶음 (1건) — 진입 + destructive/AI noop skip", async ({ page }) => {
