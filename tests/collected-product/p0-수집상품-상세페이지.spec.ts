...
const handlers: StepHandlers = {
  ...
  "tc832_ai-상품-설명": noopAfter("tc832_ai-상품-설명", 'destructive / 환경 의존 / AI 비결정 — skip'),
  "tc833_ai-상품-설명": noopAfter("tc833_ai-상품-설명", 'destructive / 환경 의존 / AI 비결정 — skip'),
  "tc835_ai-상품-설명": noopAfter("tc835_ai-상품-설명", 'destructive / 환경 의존 / AI 비결정 — skip'),
  "tc836_ai-상품-설명": noopAfter("tc836_ai-상품-설명", 'destructive / 환경 의존 / AI 비결정 — skip'),
  "tc837_ai-상품-설명": noopAfter("tc837_ai-상품-설명", 'destructive / 환경 의존 / AI 비결정 — skip'),
  "tc838_ai-상품-설명": noopAfter("tc838_ai-상품-설명", 'destructive / 환경 의존 / AI 비결정 — skip'),
};
