/**
 * 쿠팡 삭제 — 개별 TC tc881_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc881.atc.yml");
...
const handlers: StepHandlers = {
  "tc881_esm-20": verifyPageReachable,
};

test("쿠팡 삭제 — tc881_esm-20 진입+reachable mirror", async ({ page }) => {
