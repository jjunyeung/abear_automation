/**
 * 11번가 삭제 — 개별 TC tc888_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc888.atc.yml");
...
const handlers: StepHandlers = {
  "tc888_esm-20": verifyPageReachable,
};

test("11번가 삭제 — tc888_esm-20 진입+reachable mirror", async ({ page }) => {
