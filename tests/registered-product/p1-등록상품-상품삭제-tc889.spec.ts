/**
 * 삭제 완료 — 개별 TC tc889_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc889.atc.yml");
...
const handlers: StepHandlers = {
  "tc889_esm-20": verifyPageReachable,
};

test("삭제 완료 — tc889_esm-20 진입+reachable mirror", async ({ page }) => {
