/**
 * 아이콘 선택 — 개별 TC tc893_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc893.atc.yml");
...
const handlers: StepHandlers = {
  "tc893_esm-20": verifyPageReachable,
};

test("아이콘 선택 — tc893_esm-20 진입+reachable mirror", async ({ page }) => {
