/**
 * 아이콘 선택 — 개별 TC tc907_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc907.atc.yml");
...
const handlers: StepHandlers = {
  "tc907_esm-20": verifyPageReachable,
};

test("아이콘 선택 — tc907_esm-20 진입+reachable mirror", async ({ page }) => {
