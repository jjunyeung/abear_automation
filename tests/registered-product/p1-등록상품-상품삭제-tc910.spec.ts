/**
 * 삭제 완료 — 개별 TC tc910_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc910.atc.yml");
...
const handlers: StepHandlers = {
  "tc910_esm-20": verifyPageReachable,
};

test("삭제 완료 — tc910_esm-20 진입+reachable mirror", async ({ page }) => {
