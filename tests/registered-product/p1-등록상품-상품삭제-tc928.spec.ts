/**
 * 삭제 — 개별 TC tc928_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc928.atc.yml");
...
const handlers: StepHandlers = {
  "tc928_esm-20": verifyPageReachable,
};

test("삭제 — tc928_esm-20 진입+reachable mirror", async ({ page }) => {
