/**
 * 삭제 완료 — 개별 TC tc929_esm-20 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p1-등록상품-상품삭제-tc929.atc.yml");
...
const handlers: StepHandlers = {
  "tc929_esm-20": verifyPageReachable,
};

test("삭제 완료 — tc929_esm-20 진입+reachable mirror", async ({ page }) => {
