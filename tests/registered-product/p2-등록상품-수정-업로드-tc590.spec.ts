/**
 * 다음 선택 — 개별 TC tc590_업로드-설정 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p2-등록상품-수정-업로드-tc590.atc.yml");
...
const handlers: StepHandlers = {
  "tc590_업로드-설정": verifyPageReachable,
};

test("다음 선택 — tc590_업로드-설정 진입+reachable mirror", async ({ page }) => {
