/**
 * 설정 변경 — 개별 TC tc606_업로드-설정 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p2-등록상품-수정-업로드-tc606.atc.yml");
...
const handlers: StepHandlers = {
  "tc606_업로드-설정": verifyPageReachable,
};

test("설정 변경 — tc606_업로드-설정 진입+reachable mirror", async ({ page }) => {
