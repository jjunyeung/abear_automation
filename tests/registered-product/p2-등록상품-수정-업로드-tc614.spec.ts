/**
 * 담당자 변경 — 개별 TC tc614_업로드-설정 mirror spec.
...
const ATC_PATH = join(__dirname, '..', '..', 'atcs', "registered-product", "p2-등록상품-수정-업로드-tc614.atc.yml");
...
const handlers: StepHandlers = {
  "tc614_업로드-설정": verifyPageReachable,
};

test("담당자 변경 — tc614_업로드-설정 진입+reachable mirror", async ({ page }) => {
